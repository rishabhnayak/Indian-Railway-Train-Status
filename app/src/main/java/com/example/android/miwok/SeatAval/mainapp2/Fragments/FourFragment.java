...
public class FourFragment extends Fragment {
    ...
    Button button;
    String a4,d,m,y,from_code,from_name,to_code,to_name,train_name,train_no;
    String test;
...
//    https://sahu-trials.appspot.com/_ah/api/myapi/v1/seat?trainno=12070%20-%20JANSHATABDI%20EXP&dt=24-01-2018&src=TILDA%20-%20TLD&dstn=BHATAPARA%20-%20BYT&classc=2S&quota=GN
    ...
    public FourFragment(String a4, String d, String m, String y,String to_name, String from_code, String from_name, String to_code,String train_no,String train_name) {
        this.a4=a4;
        this.d=d;
        this.m=m;
        this.y=y;
...
//
    ...
    public void volley(){
        String URL ="https://sahu-trials.appspot.com/_ah/api/myapi/v1/seat?trainno="+train_name+"%20-%20"+train_no+"&dt="+d+"-"+m+"-"+y+"&src="+to_code+"%20-%20"+from_name+"&dstn="+from_code+"%20-%20"+to_name+"&classc="+a4+"&quota=GN\n";
...
//            Toast.makeText(view.getContext(), a4, Toast.LENGTH_SHORT).show();
