        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if(myobj.getResult().equals("success")) {
                    ...
                    Adapter = new live_train_selected_Item_Adaptor(sd,live_train_status_selected_item.this, words);
                        ...
                        System.out.println("Current Position of Train :"+myobj.getTrainCurrPos());
                            ...
                            listView1.post(new Runnable() {
                                ...
                                public void run() {
                                        ...
                                        listView1.smoothScrollToPosition(myobj.getTrainCurrPos()+5);

                                }
                            });
                          //  listView1.setSelection(Integer.parseInt(sd.getString("currentPosition", "")));
